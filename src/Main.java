        ...
        while (!eingabe.equals("exit")) {
            ...
            if(eingabe.startsWith("enter")) {
                ...
                while (true) {
                    ...
                    vorName = sc.next();
                    if(vorName.contains("0") | vorName.contains("1") | vorName.contains("2") | vorName.contains("3") | vorName.contains("4")
                    | vorName.contains("5") | vorName.contains("6") | vorName.contains("7") | vorName.contains("8")
                    | vorName.contains("9")) {
                        System.out.println("ungültige Eingabe, Vornamen dürfen keine Ziffern haben");
                    } else {
                        break;
                    }
                }
                ...
                while (true) {
                    ...
                    | name.contains("9")) {
                        System.out.println("Ungültige Eingabe, Namen dürfen keine Ziffern enthalten");
                    }
                    else {
                        break;
                    }
